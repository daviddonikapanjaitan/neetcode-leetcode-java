package Practice.C10HeapPriorityQueue.P6DesignTwitter;
...
public class Solution {
    ...
    public Solution() {
        ...
        List<Integer> one = twitter.getNewsFeed(1);
        System.out.println(Arrays.toString(one.toArray()));
        twitter.follow(1, 2);
        twitter.postTweet(2, 6);
        List<Integer> two = twitter.getNewsFeed(1);
        System.out.println(Arrays.toString(two.toArray()));
        twitter.unfollow(1, 2);
        List<Integer> three = twitter.getNewsFeed(1);
